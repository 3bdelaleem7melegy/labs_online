...
class myAppointmentsCholestrol extends StatefulWidget {
  const myAppointmentsCholestrol({super.key});

  @override
  _MyAppointmentsState createState() => _MyAppointmentsState();
}

class _MyAppointmentsState extends State<myAppointmentsCholestrol> {
    ...
    return Scaffold(
        ...
        body: StreamBuilder(
            stream: FirebaseFirestore.instance
                ...
                // .doc("Cholestrol")
                // .collection("all")
                .where('type', isEqualTo:'Cholesterol Test')
                .snapshots(),
