...
class myAppointmentsHeart extends StatefulWidget {
  const myAppointmentsHeart({super.key});

  @override
  _MyAppointmentsState createState() => _MyAppointmentsState();
}

class _MyAppointmentsState extends State<myAppointmentsHeart> {
    ...
    return Scaffold(
     ...
     body: StreamBuilder(
            stream: FirebaseFirestore.instance
                ...
                // .doc("Cholestrol")
                // .collection("all")
                .where('type', isEqualTo:'Heart Test')
                .snapshots(),
