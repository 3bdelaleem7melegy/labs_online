...
class myAppointmentsCreatinine extends StatefulWidget {
  const myAppointmentsCreatinine({super.key});

  @override
  _MyAppointmentsState createState() => _MyAppointmentsState();
}

class _MyAppointmentsState extends State<myAppointmentsCreatinine> {
    ...
    return Scaffold(
     ...
     body: StreamBuilder(
            stream: FirebaseFirestore.instance
                ...
                // .doc("Cholestrol")
                // .collection("all")
                .where('type', isEqualTo:'Creatinine Test')
                .snapshots(),
